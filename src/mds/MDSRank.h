...
enum {
  ...
  l_mds_traverse_lock,
  l_mds_traverse_component,
  l_mds_traverse_dentry_hit,
  l_mds_traverse_double_hash,
  l_mds_traverse_acquire_locks,
  l_mds_traverse_acquire_locks_merged,
  l_mds_traverse_linkage_plain_eligible,
  l_mds_traverse_damage_check,
  l_mds_cap_release,
  l_mds_cap_release_ignored,
  l_mds_cap_release_stale_seq,
  l_mds_cap_release_remove,
  l_mds_cap_release_eval,
  l_mds_cap_release_eval_skipped,
  l_mds_cap_release_eval_batched,
  l_mds_encode_inodestat,
  l_mds_encode_inodestat_readdir,
  l_mds_encode_inodestat_cap_issue,
  l_mds_encode_inodestat_charmap,
  l_mds_encode_inodestat_fast,
  l_mds_load_cent,
  ...
  l_mds_reactor_dispatch_queue_len,
  l_mds_dispatch_enqueue_latency,
  l_mds_dispatch_execute_latency,
  l_mds_dispatch_enqueue_hist,
  l_mds_dispatch_execute_hist,
